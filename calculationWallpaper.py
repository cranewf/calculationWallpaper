...
import math
st.title("Калькулятор для расчета количества обои")
Swindow = 0
Sdoor = 0
lengthRoomSM = st.number_input("Введите длину комнаты в сантиметрах: ")
widthRoomSM = st.number_input("Введите ширину комнаты в сантиметрах: ")
heightRoomSM = st.number_input("Введите высоту комнаты в сантиметрах: ")
lengthRoll = st.number_input("Введите длину рулона обой в метрах: ")
widthRoll = st.number_input("Введите ширину рулона обой в метрах: ")
# преобразуем см в м
...
if rapport.lower() == 'да':
    valueRapport = st.number_input("Укажи значение раппорта в метрах: ")
window = st.text_input("Есть окна? Да/Нет: ")
if window.lower() == "да":
    heightWindowSM = st.number_input("Введите высоту окна в сантиметрах: ")
    lengthWindowSM = st.number_input("Введите ширину окна в сантиметрах: ")
...
if door.lower() == "да":
    heightDoorSM = st.number_input("Введите высоту двери в сантиметрах: ")
    lengthDoorSM = st.number_input("Введите длину двери в сантиметрах: ")
